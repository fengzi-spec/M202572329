...
| **实验代表性** | 数据集构造人为制造重复前缀；模型与硬件配置偏理想，未考虑真实服务环境 |
    ...
    5.chatgpt：
    总结来说，虽然ECCA模型和提问技术在理论上的构建逻辑合理，但其实际应用落地的可行性尚需更深入的实证研究和广泛的推广试验，以确保其在真实教学环境中的有效性和价值。
...
| 质疑模型 | qwen打分 | deepseek打分 | kimi打分 | 文心一言打分 | ChatGPT打分|
|:-----------------:|:---------:|:-----:|:-----:|:---------:|:---------:|
| qwen         | 7.8      | 8.6  | 8.2  | 8.4      |8.8|
| deepseek             | 8.6      | 8.8  | 8.6  | 8.8      |8.8|
| kimi             | 8.4      | 8.4  | 8.8  | 8.6      |8.8|
| 文心一言         | 7.8      | 8.0  | 8.4  | 8.2      |8.8|
| ChatGPT         | 7.8      | 8.0  | 8.4  | 8.2      |8.8|
